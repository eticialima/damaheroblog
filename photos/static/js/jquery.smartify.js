!function(a, b, c) {
    ...
    a.fn.smartify = function(i) {
        ...
        a.extend(k, i || {}),
        f > 1 && (g = k.src_attr + "-" + (f > 2 ? "3x" : f > 1.5 ? "2x" : "1-5x")),
        null === g && (g = k.src_attr),
        e = k.container === c || k.container === b ? d : a(k.container);
        var l = function() {
            var b = 0;
            j.each(function() {
                var c = a(this);
          ...
          , o = function(b, c, d) {
            ...
            e.attr(g) && (f = a.trim(e.attr(g))),
            a("<img />").bind("load", function() {
                e.hide(),
                e.attr("src", f),
                e[c.effect](c.effect_speed),
                b.loaded = !0,
                d(),
                c.load(b, j, c)
            }).attr("src", f)
          ...
          , q = function(b, c, d) {
            ...
            if ("callback()" === h)
                ...
                b.loaded = !0,
                void d();
            if ("parent()" === h ? h = e.parent() : h && (h = a(h)),
            h.is("iframe"))
                h.attr(c.src_attr, f),
                p(h.get(0), c, d),
                n(h);
                ...
                a.ajax(i).done(function(a) {
                    "append" === g ? h.appendChild(a) : h.html(a),
                    h[c.effect](c.effect_speed),
                    n(h),
                    b.loaded = !0,
                    d(),
                    c.load_target_and_smartify && c.elements_selector && h.find(c.elements_selector).smartify(k),
                    c.load(b, j, c, a)
                }).fail(function(a, d) {
                    c.load(b, j, c, a, d)
                })
        ...
        this.each(function() {
            var b = this
              , c = a(b)
              , d = a.extend({}, k, c.data());
            d.threshold = parseInt(d.threshold),
            b.loaded = !1,
            b.no_src_attr = !1;
            ...
            return !i && !l || e || c.attr("src", d.placeholder),
            !i && !l || f ? (c.one("appear", function() {
                this.loaded || (d.appear && d.appear(b, j, d),
                i ? o(b, d, m) : g ? c.data("target") ? q(b, d, m) : h('%cAn Anchor Tag must have defined data-target="" attribute to load response content in!', "color: #ff9900;") : l ? p(b, d, m) : (m(),
                d.load(b, j, d)))
            }),
            void (d.event.indexOf("scroll") && c.bind(d.event, function() {
                b.loaded || c.trigger("appear")
            }))) : (h("%cElement has no " + d.src_attr + " defined to load", "color: #ff9900;"),
            b.no_src_attr = !0,
            void m())
        }),
        ...
        d.bind("resize orientationchange", l),
        a(b.document).ready(l),
        this
    }
    ;
    var i = function() {
    ...
    a.fn.smartify_section = function(b, c) {
        ...
        this.each(function() {
            ...
            var i = function(a) {
                h.smartify(c),
                a.target && d.scrollTop(d.scrollTop() + 2)
            };
